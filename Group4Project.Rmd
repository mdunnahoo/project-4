...
|   The exploratory plot above, plot A, shows the outcomes of matches for Tottenham as the home team in the seasons from 2011 to 2015 up until the 2014-2015 season match against Aston Villa on April 11, 2015. Tottenham won the majority of these matches and had some losses and draws.    
|   The exploratory plot above, plot B, shows the outcomes of matches for Aston Villa as the away team in the seasons from 2011 to 2015 up until the 2014-2015 season match against Tottenham. Aston Villa won just a few of its matches, but its matches mainly resulted in draws and losses. From these past results, it is reasonable to predict that Tottenham would win the match against Aston Villa.   
...
|   We ran simulations of matches that modeled Tottenham as the home team and Aston Villa as the away team to predict the outcome of the April 11, 2015 match. We compiled our results into a table that models our predictions in terms of the home team (Tottenham). Our simulations resulted in Tottenham winning the match against Aston Villa about % of the time and losing to Aston Villa about  of the time. Our findings predicted that the home team should have won the match, however Tottenham lost to Aston Villa. 
